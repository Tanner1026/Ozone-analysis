import pandas
is_on = True
hawthorne_data = pandas.read_csv("/Users/tannerrima/Downloads/ad_viz_tile_data.csv")
uintah_data = pandas.read_csv("/Users/tannerrima/Downloads/ad_viz_tile_data-3.csv")
...
def year_to_year():
    ...
    print(iter_year)
    for date in hawthorne_data["Date"]:
        if iter_year == date[x][8] + date[x][9]:
